...
public class ProcessMap implements ICommonHashmap {
    private static final Logger logger = LogManager.getLogger( ProcessMap.class );
    private HashMap<String, String> processMap = new HashMap<>();
