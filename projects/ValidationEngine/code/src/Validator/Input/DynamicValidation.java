...
public class DynamicValidation implements ICommonHashmap {
    private static final Logger logger = LogManager.getLogger( DynamicValidation.class );
    ...
    private HashMap<String, String> dynamicValidation = new HashMap<>();
